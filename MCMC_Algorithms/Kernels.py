...
class HMC(Kernel):
    def __init__(self, model, traj_len=2*np.pi, num_steps=None, stepsize=0.5, mass=1., precondition_matrix=None, use_autograd=True, silent=False, *args, **kwargs):
        ...
        if full_para is None:
            ...
            for i in range(L):
                ...
                if i != (L-1):
                    ...
                    p = clip(p + stepsize * gradient[indices])
